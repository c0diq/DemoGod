...
@class IPSView,IPSScreenView,IPSWebContainerView;

@interface IPSWindow : IPSAnimationWindow {
    NSPoint initialLocation;
	IBOutlet IPSView *phoneView;
	IBOutlet IPSScreenView *screenView;
	IBOutlet IPSWebContainerView *containerView;
